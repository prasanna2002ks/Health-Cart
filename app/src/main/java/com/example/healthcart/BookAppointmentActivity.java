...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed3 = findViewById(R.id.editTextAppMobileNum);
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(db.checkAppointmentExists(username,title+" => "+fullname,address,mobile,dateButton.getText().toString(),timeButton.getText().toString())==1){
                    ...
                    db.addOrder(username,title+" => "+fullname,address,mobile,625009,dateButton.getText().toString(),timeButton.getText().toString(),Float.parseFloat(fees),"appointment");
